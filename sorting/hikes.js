const hikes1 = ["Goldbug Hotsprings", "Tetons", "Yellowstone"];
...
const poeple = { name: "James", name: "Bob", name: "Josh" };

console.log(poeple.sort);
...
searchButton.addEventListener("click", e => {
    ...
    filteredHikes.sort(sortHIikesByDifficulty);

    outputHikes(filteredHikes);
});

function outputHikes(hikes) {
    const listElement = document.getElementById("hike-container");
...
function sortHIikesByDifficulty(a, b) {
